...
public class Modulo_4_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_modulo_4_1 );
...
// asignamos eel objeto al xml o acciones de navegacion de los botones atraves de la actividad.
        ...
        btnsiguiente.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent ( Modulo_4_1.this, Modulo_4_2.class );
        ...
        btnatras.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent ( Modulo_4_1.this, Modulo_4.class );
                startActivity ( intent );
...
//validar los chexboox
        ...
        verdadero = (RadioButton) findViewById ( R.id.rbverdadero4_1);
        falso = (RadioButton) findViewById ( R.id.rbfalso4_1);
