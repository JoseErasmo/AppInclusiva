...
public class Modulo_2_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_modulo_2_2 );
...
// asignamos eel objeto al xml o acciones de navegacion de los botones atraves de la actividad.
        ...
        btnsiguiente.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent ( Modulo_2_2.this, Modulo_2_3.class );
        ...
        btnatras.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent ( Modulo_2_2.this, Modulo_2_1.class );
                startActivity ( intent );
...
//validar los chexboox
        ...
        verdadero = (RadioButton) findViewById ( R.id.rbverdadero2_2);
        falso = (RadioButton) findViewById ( R.id.rbfalso2_2);
