...
public class Modulo_2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_modulo_2_1 );
...
// asignamos eel objeto al xml o acciones de navegacion de los botones atraves de la actividad.
        ...
        btnsiguiente.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent ( Modulo_2_1.this, Modulo_2_2.class );
        ...
        btnatras.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent ( Modulo_2_1.this, Modulo_2.class );
                startActivity ( intent );
