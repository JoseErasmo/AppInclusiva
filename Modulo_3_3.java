...
public class Modulo_3_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_modulo_3_3 );
...
// asignamos eel objeto al xml o acciones de navegacion de los botones atraves de la actividad.
        ...
        btnmenu.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent ( Modulo_3_3.this, Menu.class );
        ...
        btnatras.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent ( Modulo_3_3.this, Modulo_3_2.class );
                startActivity ( intent );
...
//validar los chexboox
        ...
        verdadero = (RadioButton) findViewById ( R.id.rbverdadero3_3);
        falso = (RadioButton) findViewById ( R.id.rbfalso3_3);
