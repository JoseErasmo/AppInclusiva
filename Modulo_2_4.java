...
public class Modulo_2_4 extends AppCompatActivity {
...
// asignamos eel objeto al xml o acciones de navegacion de los botones atraves de la actividad.
        ...
        btnatras.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent ( Modulo_2_4.this, Modulo_2_3.class );
                startActivity ( intent );
...
//validar los chexboox
        ...
        verdadero = (RadioButton) findViewById ( R.id.rbverdadero4);
        falso = (RadioButton) findViewById ( R.id.rbfalso4);
